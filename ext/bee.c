...
zend_class_entry *bee_serializer_ce;
...
#ifndef ZEPHIR_RELEASE
static PHP_MSHUTDOWN_FUNCTION(bee)
{
 ...
 */
static void php_zephir_init_globals(zend_bee_globals *zephir_globals TSRMLS_DC)
{
...
static PHP_RINIT_FUNCTION(bee)
{

	zend_bee_globals *zephir_globals_ptr = ZEPHIR_VGLOBAL;
...
static PHP_RSHUTDOWN_FUNCTION(bee)
{
...
static PHP_MINFO_FUNCTION(bee)
{
	php_info_print_box_start(0);
	php_printf("%s", PHP_BEE_DESCRIPTION);
	php_info_print_box_end();

	php_info_print_table_start();
	php_info_print_table_header(2, PHP_BEE_NAME, "enabled");
	php_info_print_table_row(2, "Author", PHP_BEE_AUTHOR);
	php_info_print_table_row(2, "Version", PHP_BEE_VERSION);
	php_info_print_table_row(2, "Powered by Zephir", "Version " PHP_BEE_ZEPVERSION);
	php_info_print_table_end();


}

static PHP_GINIT_FUNCTION(bee)
{
	php_zephir_init_globals(bee_globals TSRMLS_CC);
}

static PHP_GSHUTDOWN_FUNCTION(bee)
{
